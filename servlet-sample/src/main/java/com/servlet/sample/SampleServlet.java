...
public class SampleServlet extends HttpServlet {
    ...
    @ApiResponses({@ApiResponse(code = 400, message = "Invalid input", response = com.servlet.sample.ApiResponse
            .class)})
    @ApiImplicitParams({
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            result = Json.pretty(new com.servlet.sample.ApiResponse(400, ex.getMessage()));
        }
